...
</span> <span className="vote-type">Useful</span>
...
</span> <span className="vote-type">Funny</span>
...
</span> <span className="vote-type">Cool</span>
                <span className="count"></span>
              </a>
            </li>
...
export default ReviewsItemButtonsPanel;
