...
Telescope.registerComponent('F8UserAvatarSection',                    require('./common/F8UserAvatarSection.jsx').default)
...
Telescope.registerComponent('EditReviewTopRestaurant',             require('./reviews/editTitle/EditReviewTopRestaurant.jsx').default)
Telescope.registerComponent('EditReviewTopRecipe',                 require('./reviews/editTitle/EditReviewTopRecipe.jsx').default)
Telescope.registerComponent('EditReviewTopEvent',                  require('./reviews/editTitle/EditReviewTopEvent.jsx').default)
...
Telescope.registerComponent('IEARecipesListForRestaurantLayout',               require('./overlayrestaurant/IEARecipesListForRestaurantLayout.jsx').default)
...
Telescope.registerComponent('BaseRecipesListPage',                       require('./overlayordereduser/page/BaseRecipesListPage.jsx').default)
...
Telescope.registerComponent('OrganizationForNewEvent',                               require('./organization/OrganizationForNewEvent.jsx').default)
...
Telescope.registerComponent('UserProfileRecentActivityPanel',      require('./profile/page/UserProfileRecentActivityPanel.jsx').default)
...
Telescope.registerComponent('F8PhotosCollectionItemView',             require('./photos/photosbrowser/F8PhotosCollectionItemView.jsx').default)
...
Telescope.registerComponent('F8OrganizationTitleHeader',              require('./photos/photosbrowser/F8OrganizationTitleHeader.jsx').default)
