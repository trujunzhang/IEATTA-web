...
class OrderedUserRightMap extends Component {

  renderTopMap() {
    const {forRestaurant} = this.props;
    const latitude = forRestaurant.geoLocation.latitude;
    const longitude = forRestaurant.geoLocation.longitude;
  ...
  renderBottomText() {
    const {forRestaurant} = this.props;
    const rows = forRestaurant.address.split(',')
    return (
      <ul>
...
export default OrderedUserRightMap;
