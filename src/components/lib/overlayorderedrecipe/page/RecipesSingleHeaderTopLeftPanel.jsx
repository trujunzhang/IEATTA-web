...
import {getEditRecipeLink} from '../../../../lib/link'
...
class RecipesSingleHeaderTopLeftPanel extends Component {
  ...
  renderEditButton() {
    ...
    return (
      <Link to={getEditRecipeLink(recipe)}
        ...
        <span className="tooltip-wrapper">
                <span className="tooltip">Edit recipe</span>
              </span>
      </Link>
...
export default RecipesSingleHeaderTopLeftPanel;
