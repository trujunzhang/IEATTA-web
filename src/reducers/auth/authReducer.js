  ...
  switch (action.type) {
    ...
    case SET_STATE:
      ...
      let next = state.setIn(['form', 'state'], form.state)
        ...
        .setIn(['form', 'fields', 'email1'], form.fields.email1)
        .setIn(['form', 'fields', 'email1HasError'], form.fields.email1HasError)
        .setIn(['form', 'fields', 'email2'], form.fields.email2)
        .setIn(['form', 'fields', 'email2HasError'], form.fields.email2HasError)
